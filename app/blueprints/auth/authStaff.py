...
def registerAuthStaff():
    ...
    if(data):
        ...
        print('PHONES',phones,'EMAILS',emails)
        for phone in phones:
            query1 = 'INSERT INTO Phone_num VALUES(%s, %s)'  #added md5 to hash password
            cursor.execute(query1, (username, phone))
        
        for email in emails:
            query2 = 'INSERT INTO Email VALUES(%s, %s)'  #added md5 to hash password
